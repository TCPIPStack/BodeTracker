...
export const translations = {
  en: {
    ...
    "file.privacyDialog.body":
      "Your CSV data stays in your browser and is not sent to servers. The app uses external market data APIs for prices. You decide which file to choose. For a fully private setup, run the app locally. Source code and setup instructions are in the",
    "file.privacyDialog.repoLink": "GitHub repository",
  ...
  de: {
    ...
    "file.privacyDialog.body":
      "Deine CSV-Daten bleiben in deinem Browser und werden nicht an Server übertragen. Für Kursdaten fragt die App externe Marktdaten-APIs ab. Du entscheidest selbst, welche Datei du auswählst. Wenn du eine komplett private Variante möchtest, kannst du die App lokal ausführen. Quellcode und Anleitung findest du im",
    "file.privacyDialog.repoLink": "GitHub-Repository",
